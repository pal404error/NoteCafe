...
export default function Pdf() {
  ...
  function myPdf(e) {
    ...
    let userPdfLink = document.getElementById("txt").value;
    document.getElementById("ifram").src = userPdfLink;
    console.log(userPdfLink);
...
<input id="txt" type="text" name="PDF"/>
<button onClick={myPdf} type="submit">Click Me!</button>
